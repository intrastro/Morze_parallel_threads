...
template <typename new_type> class lister
    ...
    public:
        ...
        void clearance_false ()
            {
            clearance = false;
            }

        void clear_list_to_front ()
            {
            link_front -> link_front = new letter;

            link_front -> link_front -> link_back = link_front;

            link_front -> link_front -> link_front = new letter;

            link_front -> link_front -> link_front -> link_back = link_front -> link_front;

            link_front -> link_front -> link_front -> link_front = nullptr;
